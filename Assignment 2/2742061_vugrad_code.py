...
parser.add_argument('-res', '--residual',
                dest='residual',
                help='Wether a residual connection should be used.',
...
class MLP(vg.Module):
    ...
    def __init__(self, input_size, output_size, hidden_mult=4, residual = False):
        """
        :param input_size:
        :param output_size:
    ...
    def forward(self, input):
        ...
        # third layer
        output = self.layer3(hidden_2) # By adding one hidden layer to the other we are creating a residual connection
...
mlp = MLP(input_size=num_features, output_size=num_classes, residual = args.residual)
